<?php 
    ...
    $fantasy_movie = new Genre("Fantastico", "Il genere fantastico è un genere narrativo che introduce elementi soprannaturali o non spiegabili razionalmente nella realtà, spesso con la presenza di magia, creature leggendarie e mondi immaginari.");
